...
namespace Deadlines {
  public static partial class DeadlineService
  {
    ...
    /// <summary>Base class for server-side implementations of DeadlineService</summary>
    [grpc::BindServiceMethod(typeof(DeadlineService), "BindService")]
    public abstract partial class DeadlineServiceBase
    {
      public virtual global::System.Threading.Tasks.Task<global::Deadlines.DeadlineResponse> DieOrNot(global::Deadlines.DeadlineRequest request, grpc::ServerCallContext context)
      {
    ...
    public static grpc::ServerServiceDefinition BindService(DeadlineServiceBase serviceImpl)
    {
      return grpc::ServerServiceDefinition.CreateBuilder()
          .AddMethod(__Method_DieOrNot, serviceImpl.DieOrNot).Build();
    }
    ...
    /// <param name="serviceImpl">An object implementing the server-side handling logic.</param>
    public static void BindService(grpc::ServiceBinderBase serviceBinder, DeadlineServiceBase serviceImpl)
    {
      serviceBinder.AddMethod(__Method_DieOrNot, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Deadlines.DeadlineRequest, global::Deadlines.DeadlineResponse>(serviceImpl.DieOrNot));
    }
